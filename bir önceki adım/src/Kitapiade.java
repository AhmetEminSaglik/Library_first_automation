...
public class Kitapiade extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField2.setText("Kitap yazarı (değiştirilemez)");

        jTextField3.setText("Ogrenci adi  (değiştirilemez)");

        jTextField4.setText("Kitap iade edildi (değiştirilemez)");

        jTextField5.setText("Öğrenci numarası");

        jTextField6.setText("kitap adi  (değiştirilemez)");
