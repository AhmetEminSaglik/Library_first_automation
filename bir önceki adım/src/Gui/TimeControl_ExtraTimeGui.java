...
public class TimeControl_ExtraTimeGui extends JPanel {
    ...
    JTable tbl;
    JScrollPane sp;
    String HeaderOfTable[] = {"Öğrenci No", "Kitap No", "Kitap adı", "Kalan gün sayısı "};
    String dataForTable[][] = {
    ...
    public JTable getTbl() {
        if (tbl == null) {
            ...
            tbl.getColumnModel().setColumnMargin(50);
